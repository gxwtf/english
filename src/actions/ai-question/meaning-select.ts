...
8. **极其重要：干扰选项（即除正确答案外的 3 个选项）绝对不能是目标单词的任何释义（或者某个释义的近义词）！** 干扰选项必须来自单词列表中**其他单词**的释义，或者与目标单词无关的常见中文释义。这样可以确保用户必须真正理解单词含义才能选出正确答案，而不是仅凭排除同义词就能猜对。**严禁模棱两可，必须要有明确的答案**。
